...
import type {
  UseDeviceThemeProps,
  DeviceThemeProviderProps,
} from './dark-provider.d';

const colorSchemes = ['light', 'dark'];
const MEDIA = '(prefers-color-scheme: dark)';
const isServer = typeof window === 'undefined';
const ThemeContext = createContext<UseDeviceThemeProps | undefined>(undefined);
const defaultContext: UseDeviceThemeProps = { setTheme: _ => { }, themes: [] };

export const useDeviceTheme = () => useContext(ThemeContext) ?? defaultContext;

export const DeviceThemeProvider: React.FC<
  DeviceThemeProviderProps
> = props => {
...
const Theme: React.FC<DeviceThemeProviderProps> = ({
  forcedTheme,
...
const ThemeScript = memo(
  ({
    ...
    attrs,
    nonce,
  }: DeviceThemeProviderProps & { attrs: string[]; defaultTheme: string }) => {
